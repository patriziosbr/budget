...
//           </p>
//         </div>
//         <div id="todays-money-card"></div>
//         <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
//           <div class="card">
//             <div class="card-header p-2 ps-3">
//               <div class="d-flex justify-content-between">
//                 <div>
//                   <p class="text-sm mb-0">Annual progress</p>
//                   <h4 class="mb-0">2300</h4>
//                 </div>
//               </div>
//             </div>
//             <div class="card-footer p-2 ps-3">
//               <p class="mb-0 text-sm">From start of year</p>
//             </div>
//           </div>
//         </div>
//         <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
...
//               <div class="d-flex justify-content-between">
//                 <div>
//                   <p class="text-sm mb-0">Annual compare</p>
//                   <h4 class="mb-0">3,462</h4>
//                 </div>
//                 <div class="d-flex align-items-center icon-shape text-dark text-center border-radius-lg">
//                   <BsFillInfoCircleFill size={20} className='align-middle opacity-8 m-auto' title="Year 2024/2025"/>
//                 </div>
//               </div>
//             </div>
//             <div class="card-footer p-2 ps-3">
//               <p class="mb-0 text-sm"><span class="text-danger font-weight-bolder">-2% </span>than last year</p>
//             </div>
//           </div>
//         </div>
...
//               <div class="d-flex justify-content-between">
//                 <div>
//                   <p class="text-sm mb-0">Higher category</p>
//                   <h4 class="mb-0">800</h4>
//                 </div>
//               </div>
//             </div>
//             <div class="card-footer p-2 ps-3">
//               <p class="mb-0 text-sm"><span class="text-success font-weight-bolder">+5% </span>than others</p>
//             </div>
//           </div>
//         </div>
//       </div>
...
//                       </td>
//                       <td class="align-middle text-center text-sm">
//                         <span class.jsx="text-xs font-weight-bold"> $500 </span>
//                       </td>
//                       <td class="align-middle">
//                         <div class="progress-wrapper w-75 mx-auto">
//                           <div class="progress-info">
